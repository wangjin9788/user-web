        ...
        <el-row :gutter="20">
          <el-col :span="8">
            <div class="un-handle-item">
              <span class="font-medium">养殖编号</span>
              <span style="float: right" class="color-danger">{{scope.row.number}}</span>
            </div>
          </el-col>
          <el-col :span="8">
            <div class="un-handle-item">
              <span class="font-medium">养殖模式</span>
              <span style="float: right" class="color-danger">{{scope.row.evaluate}}</span>
            </div>
          </el-col>
          <el-col :span="8">
            <div class="un-handle-item">
